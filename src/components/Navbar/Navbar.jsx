...
const Navbar = () => {
    ...
    try {
      ...
      if (newCount !== unreadCount && newCount > 0) {
        ...
        if (badge) {
          ...
          setTimeout(() => badge.classList.remove("notification-bounce"), 600)
        }
      }
  ...
  const dismissNotifications = async (notificationIds) => {
    try {
      ...
      console.log("🗑️ Dismissing notifications:", notificationIds)
      setNotificationLoading(true)

      await axios.post(
        `${API_BASE_URL}/notifications/dismiss`,
        { notificationIds },
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
      ...
      Swal.fire({
        title: "Dismissed",
        text: "Notification dismissed successfully",
        icon: "success",
        timer: 1500,
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
            {isAuthenticated ? (
              <>
                ...
                <div className="relative ml-6 pl-6 border-l border-gray-200 dark:border-gray-700" ref={notificationRef}>
                  <button
                    onClick={toggleNotificationDropdown}
                    className="relative p-3 rounded-xl bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-900/20 dark:hover:to-indigo-900/20 transition-all duration-500 group shadow-lg hover:shadow-xl transform hover:scale-110"
                    aria-label="Notifications"
                  >
                    <svg
                      className="w-6 h-6 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-all duration-300 group-hover:rotate-12"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    {unreadCount > 0 && (
                      <span className="notification-badge absolute -top-2 -right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs rounded-full h-6 w-6 flex items-center justify-center font-bold shadow-lg ring-2 ring-white dark:ring-gray-900 animate-pulse">
                        {unreadCount > 99 ? "99+" : unreadCount}
                      </span>
                    )}
                    {unreadCount > 0 && (
                      <span className="absolute -top-2 -right-2 h-6 w-6 rounded-full bg-red-400 animate-ping opacity-75"></span>
                    )}
                  </button>

                  {isNotificationOpen && (
                    <div className="absolute right-0 mt-3 w-96 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 py-2 z-50 animate-in slide-in-from-top-2 duration-300 backdrop-blur-xl">
                      <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-t-2xl">
                      ...
                      <div className="max-h-80 overflow-y-auto">
                        {notifications.length > 0 ? (
                          notifications.slice(0, 5).map((notification, index) => (
                            <div
                              key={notification.id}
                              className="px-6 py-4 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-900/10 dark:hover:to-indigo-900/10 transition-all duration-300 border-b border-gray-100 dark:border-gray-700/50 last:border-b-0 group"
                              ...
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  <div className="flex items-center space-x-2 mb-2">
                                    ...
                                    <p className="text-sm font-semibold text-gray-900 dark:text-white line-clamp-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                                ...
                                <button
                                  ...
                                  className="ml-3 p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-all duration-300 transform hover:scale-110"
                                  title="Dismiss"
                                >
                                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path
                      ...
                      {notifications.length > 0 && (
                        <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-b-2xl">
                          <Link
                            to="/profile"
                            onClick={() => setIsNotificationOpen(false)}
                            className="block w-full text-center py-2 px-4 text-sm font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                          >
          ...
          <div className="md:hidden flex items-center space-x-2">
            {isAuthenticated && (
              <div className="relative" ref={notificationRef}>
                <button
                  onClick={toggleNotificationDropdown}
                  className="relative p-2.5 rounded-xl bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-900/20 dark:hover:to-indigo-900/20 transition-all duration-500 shadow-lg hover:shadow-xl transform hover:scale-110"
                  aria-label="Notifications"
                >
                  <svg
                    className="w-5 h-5 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  {unreadCount > 0 && (
                    <span className="notification-badge absolute -top-1 -right-1 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold shadow-lg ring-2 ring-white dark:ring-gray-900 animate-pulse">
